...
public class JustifiedTextView extends android.support.v7.widget.AppCompatTextView
{
    ...
    public static Align _align=Align.RIGHT;
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        /*Matcher matcher = Pattern.compile(" ([\u0500-\u08FF0-9_-]+)").matcher(spanString);
        ...
        Linkify.addLinks(this, Linkify.ALL);//Enables all available links in text
    }
}
